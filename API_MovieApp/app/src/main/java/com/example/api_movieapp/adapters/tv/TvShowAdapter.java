package com.example.api_movieapp.adapters.tv;
...
import com.example.api_movieapp.models.tv.TvShow;
...
public class TvShowAdapter extends RecyclerView.Adapter<TvShowAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.tv_recycleritem, parent, false);
